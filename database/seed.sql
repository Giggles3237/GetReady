INSERT INTO action_definitions (action_key, label, role, action_type, enabled, sort_order) VALUES
  ...
  ('removed_from_detail', 'Move Vehicle Out of Detail', 'bmw_genius', 'status', TRUE, 40),
  ('complete_qc', 'Complete Final QC', 'manager', 'flag', TRUE, 50),
  ('start_service', 'Start Service', 'service_advisor', 'flag', TRUE, 60),
  ('complete_service', 'Complete Service', 'service_advisor', 'flag', TRUE, 70),
  ('start_bodywork', 'Start Body Work', 'service_advisor', 'flag', TRUE, 80),
  ('complete_bodywork', 'Complete Body Work', 'service_advisor', 'flag', TRUE, 90),
  ('toggle_recall', 'Check Recalls', 'service_advisor', 'flag', TRUE, 100),
  ('complete_recall', 'Complete Recall Work', 'service_advisor', 'flag', TRUE, 110),
  ('toggle_fueled', 'Fuel Vehicle', 'bmw_genius', 'flag', TRUE, 120),
